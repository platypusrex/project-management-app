...
import '../../styles/components/SkeletonScreen.css';

export const SkeletonScreen = (props) => {
	return (
		<svg viewBox='0 0 300 70' xmlns='http://www.w3.org/2000/svg' fillRule='evenodd' clipRule='evenodd' strokeLinejoin='round' strokeMiterlimit='1.414'>
			<defs>
